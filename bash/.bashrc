...
if [ "$color_prompt" = yes ]; then
	PS1="${debian_chroot:+($debian_chroot)}\[$GRAY\]\u@\h\:\[$BLUE\]\w\[$BROWN\]\$(parse_git)\[$BROWN\]\n▶\[$END_COLOR\] "
else
...
[ -s "/home/thiago/.gvm/scripts/gvm" ] && source "/home/thiago/.gvm/scripts/gvm"

export PATH=$PATH:$GOROOT/bin:$GOPATH/bin
export GOBIN=$GOPATH/bin
export GOPATH=$GOPATH:$HOME/repo

export NVM_DIR="/home/thiago/.nvm"
